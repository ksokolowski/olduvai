...
# Display-L3 surface walk with attacks — ends in a game over.
#
...
# `scenarios/l3_icy_walk.jsonl`, byte for byte.  It was ALREADY
...
# count IS wall-clock: 190 frames cannot run faster than it does.  The ten
...
#       --replay tests/fixtures/l3_icy_walk.jsonl \
#       --trace tests/fixtures/golden_l3_icy_walk.jsonl \
...
exec sh "$(dirname "$0")/lib/trace_gate.sh" golden_trace_l3_icy_walk 3 - \
    l3_icy_walk.jsonl golden_l3_icy_walk.jsonl 190 120 \

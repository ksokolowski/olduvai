...
# are exchanged (see CLAUDE.md).  Display level 7 is internal 7, which is why
...
# the obstacles: 3 crossings, 10 -> 11 -> 12 -> 13, and coverage rises
# to 56.0%.  Screen 13 (0xD) is
# the teleport-entry special case in check_l7_transition.
#
...
#   ./build/release/olduvai --play --level 7 --start-screen 10 \\
#       --replay tests/fixtures/walk_jump_in.jsonl \\
#       --trace tests/fixtures/golden_trace_walk_l7.jsonl \\
#       --play-frames 300 --game-dir <game_dir>
#
# Skip (77) when game data or the binary is absent.

exec sh "$(dirname "$0")/lib/trace_gate.sh" golden_trace_walk_l7 7 10 \
    walk_jump_in.jsonl golden_trace_walk_l7.jsonl 300 180 \

...
//
// Prehistorik is a flip-screen game: each 320x200 screen is a self-contained
...
// center 320x200 frame and optional left/right 320x200 neighbor frames.
...
//       - With a non-null `backdrop` (the pure HUD-erased FOND, 320x200 RGBA,
